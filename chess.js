...
const PIECES = {
  ...
  Black_Knight: "&#9822",
  Black_Pawn: "&#9823",
}; // global - all functions can access
...
/**
 * Finds the cell corresponding to the chessboard label.
 *
 * @param {string} label a two-character label, where the column is the first character and the row is the second character
 * @returns the HTML element corresponding to the label.
 */
...
/**
 * Converts a row label to an index in a 0-based array of rows,
 * selected from top to bottom.
 *
 * For example, the label "7" corresponds to index 2 because
 * it is at position 2 in a 0-based array starting from the top.
 *
 * @param {string} label - a row label: one of "1" - "8"
 * @returns the position of the row from the top, the first being 0
 */
...
/**
 * Converts a column label to an index in a 0-based array of columns,
 * selected from left to right.
 *
 * For example, the label "B" corresponds to index 2 because
 * it is at position 2 in a 0-based array starting from the left.
 *
 * @param {string} label - a column label: one of "A" - "H"
 * @returns the position of the column from the left, the first being 0
 */
